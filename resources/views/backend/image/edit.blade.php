    ...
    <div class="mb-4 d-flex">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ url('admin/images') }}"> Images List
                    </a>
                </li>
        ...
        <div class="col-md-12 justify-content-center">
            <form method="POST" action="{{ route('admin.images.update', $image->id) }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card mb-4">
                            <div class="card-body">
                                <div class="mb-3">
                                    <label class="form-label">Image (600px*400px) (optional)</label><br>
                            ...
                            <div class="card-body">
                                <div class="mb-6">
                                    ...
                                    <select class="form-select @error('status') is-invalid @enderror" name="status">
                                        ...
                                        <option value="1" @if (old('status', $image->status) == '1') selected @endif>Publisb
                                        </option>
                                        <option value="0" @if (old('status', $image->status) == '0') selected @endif>Draft
                                        </option>
                                    </select>
                                    @error('status')
                                        <span class="invalid-feedback" role="alert">
                ...
                <div class="modal-footer">
                    <a href="{{ url('admin/images') }}" type="button" class="btn btn-danger">Cancel</a>
