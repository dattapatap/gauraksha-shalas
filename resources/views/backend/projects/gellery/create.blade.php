...
@section('content')
    <div class="mb-4 d-flex">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('admin.projects.gallery', $project->slug) }}"> Gallery
                    </a>
                </li>
    ...
    <div class="row">
        <div class="col-md-12 justify-content-center">
            ...
            <form method="POST" action="{{ route('admin.projects.gallery.store', $project->slug) }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="card mb-4">
                            ...
                            <div class="card-footer d-flex justify-content-end gap-2">
                                <a href="{{ route('admin.projects.gallery', $project->slug) }}" type="button" class="btn btn-danger btn-update">Cancel</a>
