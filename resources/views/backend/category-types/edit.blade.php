        ...
        <div class="col-md-12 justify-content-center">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-md-12">
                        <form method="POST" action="{{route('admin.category-types.update', $CategoryType->id)}}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                             <div class="row">
                                <div class="mb-3">
                                    <label class="form-label">Banner Image ( 1050 * 600 )</label><br>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name"
                                        ...
                                        value="{{ old('name', $CategoryType->name)}}" placeholder="Category Type Name">
                             ...
                             <div class="row">
                                <div class="col-6 mb-3">
                                    ...
                                    <select class="form-select category @error('category') is-invalid @enderror" name="category" id="category">
                                        ...
                                        @foreach ($categories as $cat)
                                            <option value="{{ $cat->id }}" @if(old('category', $CategoryType->category_id)==   $cat->id  )   selected @endif > {{ $cat->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('category')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <select class="form-select sub_category @error('sub_category') is-invalid @enderror" id="sub_category" name="sub_category">
                                        <option selected value="{{ $CategoryType->sub_category_id }}"> {{ $subCategories->name }} </option>
                                    </select>
                            ...
                            <div class="row">
                                <div class="col-6 mb-3">
                                    ...
                                    <select class="form-select @error('status') is-invalid @enderror" name="status">
                                        ...
                                        <option value="1" @if(old('status', $CategoryType->status)== '1')   selected @endif >Active</option>
                                        <option value="0" @if(old('status',  $CategoryType->status)== '0')   selected @endif >Inactive</option>
                                    </select>
                                    @error('status')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <select class="form-select @error('show_front') is-invalid @enderror" name="show_front">
                                        <option value="0" @if(old('status', $CategoryType->status)== '0')   selected @endif >No</option>
                                        <option value="1" @if(old('status', $CategoryType->status)== '1')   selected @endif >Yes</option>
                                    </select>
                                    @error('show_front')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
