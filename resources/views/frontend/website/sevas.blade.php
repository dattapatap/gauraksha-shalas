            ...
            <div class="col-lg-8 col-md-12">
                <div class="blog-details">
                        ...
                        <section>
                            <div id="jssor_1"
                                ...
                                <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:800px;height:400px;overflow:hidden;">
                                    ...
                                    @foreach ($seva->seva_images as $item)
                                    <div data-p="170.00">
                    ...
                    <div class="article-content">
                        <h3> {{ $seva->heading }}</h3>
                        <p>
                            {!! $seva->short_description_1 !!}
                        </p>
                        <p>
                            {!! $seva->short_description_2 !!}
                        </p>
                        <p>
                            {!! $seva->long_description !!}
                        </p>
            ...
            <div class="col-lg-4 col-md-12">
                <aside class="widget-area" id="secondary">
                    <section class="widget widget_categories">
                        <h3 class="widget-title">Sevas</h3>
                        <ul>
                            @foreach($lstSevas as $item)
